...
public class CompleteTripActivityEnterId extends AppCompatActivity {
    Button btn_scan;
    ImageView imageView;
    EditText batchId;
    String username;
  ...
  //  private DrawerLayout drawerLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_trip_enter_id);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(batchId.getText().toString().trim().isEmpty()){
                    ...
                    Intent i=new Intent(CompleteTripActivityEnterId.this,CompleteTripActivity.class);
