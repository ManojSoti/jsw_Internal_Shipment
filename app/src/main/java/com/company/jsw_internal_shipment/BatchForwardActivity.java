...
public class BatchForwardActivity extends AppCompatActivity {
    Button btn_scan;
    ImageView imageView;
    EditText batchId;
    String username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batch_forward);
            ...
            public void onClick(View v) {
                if(batchId.getText().toString().trim().isEmpty()){
                    batchId.setError("Batch Id cannot be empty");
                      ...
                      Intent i=new Intent(BatchForwardActivity.this,BatchDetailsForwardActivity.class);
