...
public class CompleteTripDestinationFinish extends AppCompatActivity {
    ...
    static List<BatchDetailsBean> batchDetailsBeanLists=new LinkedList<>();;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_complete_trip_destination_finish);
    ...
    public void getBatchDetails(String url,String batchId,String username){
        ...
        try{
            ...
            String load_unload=String.valueOf(EncryptionDecryption.encrypt("SAVITHRU-x!A%D*G","3"));
                ...
                if (response.getString("status").equals("success")) {
                    ...
                    complete.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            completeTrip(ApiLinks.completeTripUrl, batchDetailsBeanLists,"1",username);
                            //startActivity(next);
                        }
                    });

                }else {
                    AlertDialog.Builder builder = new AlertDialog.Builder(CompleteTripDestinationFinish.this);
