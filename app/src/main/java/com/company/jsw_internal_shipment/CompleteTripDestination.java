...
public class CompleteTripDestination extends AppCompatActivity {
    Button btn_scan;
    ImageView imageView;
    EditText batchId;
    String username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete_trip_destination);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(batchId.getText().toString().trim().isEmpty()){
                    ...
                    Intent i=new Intent(CompleteTripDestination.this,CompleteTripActivity.class);
